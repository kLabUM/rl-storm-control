...
load_model="prof_80.h5"#(sys.argv[3])
#write_model=(sys.argv[4])
epi_start=0.0#float(sys.argv[1])
epi_end = 0.0#float(sys.argv[2])
...
while time_sim < timesteps:
    ...
    while episode_timer < time_limit:
        ...
        for i in nodes_controlled.keys():
            ...
            actions_tracker.append(action_step/100.0)
