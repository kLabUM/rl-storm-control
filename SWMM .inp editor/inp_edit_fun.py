...
def storm_event(input_file_1, output_file, field, series_name, time, intensity):
    ...
    Arguments
        ...
        field         =  Field to modify
                      --> Current Support for TIME-SERIES
        series_name   =  Time series name(retain the same name)
        time          =  Duration of the storm
        intensity     =  Intensity of the rainfall
    ___________________________________________________________
    Outputs
        write the time series in the output file
    """
