...
def reward_function(height_pond, outflow_pond):
    if height_pond <= 2.0:
        if outflow_pond <= 0.10:
            return 1.0 - 0.25 * height_pond + 1.0
        else:
            return -10.0*outflow_pond + 2.0 - 0.25 * height_pond + 1.0
    else:
        if outflow_pond <= 0.10:
            return 1.0 - 1.50 * height_pond + 1.0
        else:
            return -10.0*outflow_pond + 2.0 - 1.50*height_pond + 1.0
