...
model1.load_weights('trained_weights/constant_inflow/pond1_030.h5')
model2.load_weights('trained_weights/constant_inflow/pond2_030.h5')
...
while episode_time < 7201:
    ...
    action_tracker_pond1.append(action_pond1/10.0)
    action_tracker_pond2.append(action_pond2/10.0)
