...
def reward(overflow1, overflow2, outflow):
    ...
    return reward_out - overflow1*100 - overflow2*100
...
time = 0
steps = 150000
epsilon = np.linspace(0.4, 0.01, steps+10)
...
flooding_pond1 = []
flooding_pond2 = []
# model1.load_weights('pond1_1_0201_no.h5')
# model2.load_weights('pond1_1_0201_no.h5')
...
while time < steps:
    ...
    if episode_counter % 5 == 0:
        print 'model save'
        model1.save_weights('no_hope_p1.h5')
        model2.save_weights('no_hope_p2.h5')
